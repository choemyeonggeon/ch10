package com.gready.section02.string;
...
public class Application01 {
	...
	public static void main(String[] args) {
		...
		/*compareTo() : 인자로 전잘된 문자열과 사전 순으로 비교를 하여
		 * 두 문자열이 같다면 0을 반환, 인자로 전잘된 문자열보다 작으면 음수를,
		 * 크면 양수를 반환한다.
		...
		System.out.println("comparTo() :" + (str2.compareTo(str3)));
		
		System.out.println("comparTo() :" + (str2.compareTo(str4)));
		System.out.println("comparTo() :" + (str4.compareTo(str2)));
...
//		System.out.println(ext);
		 ...
		 * 단, 일치하는 문자가 없는 경우 -1을 반환한다. */
		System.out.println("lastIndextOf('a') :" + indexOf.lastIndexOf('a'));
		System.out.println("lastIndextOf('z') :" + indexOf.lastIndexOf('z'));
...
//		System.out.println(s2.equals("java"));
		...
		/*replace() : 문자열에서 대체할 문자열로 가는 문자열을 변경해서 반환한다.
		 * 원본에 영향을 주지 않는다.
		 * */
		String javaoracle = "javaoracle";
		
		System.out.println("relpace() : " + javaoracle.replace("java", "python"));
...
//		System.out.println(badFileName.replaceAll("../",""));
		...
		/*isEmpty() : 문자열의 길이가 0이면 true를 반환, 아니면 fasle를 반환
...
//		String ckeckBlank = (checkBlank != null && checkBlank.isEmpty());
