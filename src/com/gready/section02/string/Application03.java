...
public class Application03 {
	...
	public static void main(String[] args) {
		...
		/*마지막 구분자 사이에 값이 존재하지 않는 경우 이후 값도 추출하고 싶을 떄
		 * 몇 개의 토큰으로 분리할 것인지 한계치를 두 번쨰 인자로 넣어줄 수 있다.
		 * 이 떄 음수를 넣게 되면 마지막 구분자 뒤의 값이 존재하지 않는 경우 빈 문자열로 토큰을 생성한다.*/
		...
		/* nextToken()으로 토큰을 꺼내면 해당 StringTokenizer의 토큰을 재샤용 하는 것이 불가능하다*/
//		while(st1.hasMoreTokens()) {
//			System.out.println("st1 : " + st1.nextToken());
//		}
