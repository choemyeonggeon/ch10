...
public class Application02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("locaeTime :" + localTime);
		...
		System.out.println("locaeDate :" + localDate);
		...
		System.out.println("월 중에 몇 번쨰 열 :" + localDate.getDayOfMonth());
		System.out.println("1년 중에 몇 번쨰 일 :" + localDate.getDayOfYear());
		System.out.println("한 주의 몇번쨰 일 : " + localDate.getDayOfWeek());

		ZonedDateTime zonedDateTime = ZonedDateTime.now();
		System.out.println("zonedDateTime :" + zonedDateTime);
		System.out.println("zone정보 : + " + zonedDateTime.getZone());
